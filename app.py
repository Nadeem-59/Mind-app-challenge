...
st.markdown(
    ...
    <style>
        ...
        .block-container {
            ...
            background-color:rgb(226, 199, 238);  /* Slightly lighter shade for contrast */
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3);  /* Adds subtle shadow for depth */
        }
        h1, h2, h3, h4, h5, h6 {
            color:rgb(33, 109, 160);  /* Light blue color for headings to stand out */
        }
        .stButton>button {
            border: none;
            border-radius: 8px;  /* Rounds button edges */
            background-color:rgb(243, 185, 118);  /* Primary blue for buttons */
...
st.title("Advanced Data Sweeper Sterling Integrator By Mustabshira Khalid")  # Large, eye-catching title
